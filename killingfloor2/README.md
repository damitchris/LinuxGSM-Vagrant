...
<p>This is a fork. Made to be used with CentOS</p>
<p>Made to run killing floor 2</p>
<p>Thanks LinuxGSM for the vagrant version</p>

<p>Known issues</p>
<p>needs to add ip address</p>
<p>need to add steam id</p>
